...
class ViewController: UIViewController, ARDataSource {
    ...
    func showARViewController() {
        ...
        arViewController.uiOptions.setUserLocationToCenterOfAnnotations = Platform.isSimulator || UserDefaults.standard.string(forKey: "userLocationToCenterOfAnnotations") == "true"
