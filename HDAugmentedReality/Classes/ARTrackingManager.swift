...
public class ARTrackingManager: NSObject, CLLocationManagerDelegate {
    ...
    fileprivate var locationSearchTimer: Timer?
    fileprivate var locationSearchStartTime: TimeInterval?
    ...
    public func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if age < -self.minimumLocationAge || location.horizontalAccuracy > self.minimumLocationHorizontalAccuracy || location.horizontalAccuracy < 0 {
            Log.logger?.warning("Disregarding location: age: \(age), ha: \(location.horizontalAccuracy)")
            return
        }
        ...
        {
            Log.logger?.warning("== \(location.horizontalAccuracy), \(age) \(location.coordinate.latitude), \(location.coordinate.longitude), \(location.altitude)" )
        }*/
